...
const introPhotoObserver = new IntersectionObserver(function (
  entries,
  introPhotoObserver
) {
...
const instagramObserver = new IntersectionObserver(function (
  entries,
  instagramObserver
) {
  entries.forEach((entry) => {
...
const courseShowDesBut = document.querySelector(
...
document.querySelector(
  "#footer__date"
).innerText = `Copyright © ${new Date().getFullYear()} Emanuel Kulesza`;
